...
class NukeQuickReviewTcs(sgtk.platform.Application):
    """
    ...
    def init_app(self):
        ...
        nuke.tk_nuke_tcs_quickreview = self

        # make the base plugins available via the app
        tk_nuke_tcs_quickreview = self.import_module("tk_nuke_tcs_quickreview")
        self._base_hooks = tk_nuke_tcs_quickreview.base_hooks

        # add to nuke node menu
        icon = os.path.join(self.disk_location, "resources", "node_icon.png")

        self.engine.register_command(
            "SG Quick Review Tcs", self.create_node, {"type": "node", "icon": icon}
        )
    ...
    def create_node(self):
        ...
        nk_file = os.path.join(
            self.disk_location, "resources", "tk_nuke_tcs_quickreview.nk"
        )
    ...
    def create_review(self, group_node):
        ...
        self.engine.show_dialog(
            ...
            self,
            tk_nuke_tcs_quickreview.Dialog,
